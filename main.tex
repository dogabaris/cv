...
% === SKILLS ===
    ...
    \begin{description}
   				\item[Software frameworks:] .NetCore, Cobra (golang), React, Angular, NodeJs, Android, Elasticsearch.
				\item[Programming languages:] C\#, Golang, Javascript, Java, Python.
...
% === References ===
   \section{\mysidestyle References}
	...
	Selman Kayrancıoğlu 0505 588 5593 from Peak Games  \\
   Göksel Pırnal 0539 477 50 88 from KKB Kredi Kayıt Bürosu  \\
   Ayşegül Parlan 0539 272 1763 from Ex-Shopi, present LC Waikiki 
...
% === Publications ===
      ...
      \item \textbf{Implementation Of Artificial Neural Netwowrks On Graph Databases (Master Thesis)}  \href{https://tez.yok.gov.tr/UlusalTezMerkezi/TezGoster?key=9MiDp3x86xrwjpi5-14w-UtEROyGqn1L_T_lPOW6pMQtXAFf9KUIzge2B1hkBAbb}{[link]}, YÖK Thesis Center Council Of Higher Education, 2021 \\
...
% === HISTORY ===
       ...
       \begin{description}       
       		...
       		Worked as a backend software  developer in the Order Management System and Claim teams of Hepsiburada, one of the leading platforms of e-commerce in Turkey. Took part in the design and development of fulfillment and claim systems for all orders. Took part in the development of systems based on Domain Driven Design with CQRS pattern in micro service architecture. Used C\#, Golang, React, Javascript, Nodejs, Python and Message Broker technologies. Been involved in the frontend development of pages used by millions of customers, administrators and vendors. Award-winning claim policies developed with the team. Worked with NoSql and Sql database technologies. Used ElasticSearch as search engine. 
